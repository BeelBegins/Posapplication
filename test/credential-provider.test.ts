...
const config=async()=>({baseUrl:"https://erp.example.com",clientId:"public-client",redirectUri:"com.beelbegins.aimaticpos://oauth/callback",scope:"pos-device"});
