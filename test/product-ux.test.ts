...
test("Sales navigation, offline statuses, and safe retry are visible", () => {
  ...
  assert.match(api, /getActivePromotions/);
  assert.match(api, /getVisitSchedule/);
  assert.match(api, /logVisit/);
  assert.match(api, /updateVisit/);
  ...
  assert.match(app, /orderProofPanel/);
  assert.match(app, /assertOrderProofReady/);
  assert.match(app, /signature_base64/);
  assert.match(app, /managerDashboardPanel/);
  ...
  assert.match(styles, /\.promotion-panel/);
  assert.match(styles, /\.visit-route/);
  assert.match(styles, /#order-signature/);
  assert.match(styles, /\.manager-dashboard/);
