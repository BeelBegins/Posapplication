...
Android POS instead needs an HTTPS ERPNext URL and a one-time enrollment QR generated by a POS Supervisor or System Manager. Device configuration and OAuth tokens are stored using Android Keystore-backed encrypted storage.
